...
**Phase 1, in progress.** The customer/property/timeline core and the legacy
data migration are working and tested. No UI yet — that's next.
...
Phase 1 (now) customer, timeline, property profiles, photos
Phase 2 service and dispatch
Phase 3 inventory
