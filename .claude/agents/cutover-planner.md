...
Be honest about status. `DEMO.md`'s own tables — "written but never run against a real server" — are the standard. If Phase 1 is not actually done, say so before planning Phase 2.
